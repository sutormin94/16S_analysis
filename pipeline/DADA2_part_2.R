...
seqtab.nochimOTU <- read.table(file = "/home/niagara/Storage/MetaRus/V_Mamontov/results_16S/OTUs_output/OTU_table.tsv", 
...
write.table(taxa, sep="\t", file = "/home/niagara/Storage/MetaRus/V_Mamontov/results_16S/OTUs_output/Sponges/all_OTUs_phylogeny.tsv", col.names = NA)
write.table(taxa.print, sep="\t", file = "/home/niagara/Storage/MetaRus/V_Mamontov/results_16S/OTUs_output/Sponges/all_phylogeny.tsv", col.names = NA)
...
write.table(seqtab.nochim.exportOTU, sep="\t", 
            file = "/home/niagara/Storage/MetaRus/V_Mamontov/results_16S/OTUs_output/Sponges/all_OTU_frequency.tsv", col.names = NA)
